...
> "Investiga cómo se generan los slugs de producto en `data/products.ts`.
> Escribe tus hallazgos en `progress/research_slugs.md`. Tu respuesta a mí debe
> ser solo: `done -> progress/research_slugs.md` o un mensaje de bloqueo."
...
- ❌ Editar archivos en `lib/`, `app/`, `components/` o `tests/`.
